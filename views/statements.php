  ...
  <div class="bg-ak-card rounded-xl border border-ak-red/30 mb-5 overflow-hidden animate-fade-in-up">
    ...
    <div class="sh nagare-header">
      ...
      <div class="sa">
        ...
        <button onclick="openWhatsApp('<?= h($nagareWAUrl) ?>', <?= (int)$m['id'] ?>, <?= (int)$activeAuctionId ?>, <?= round($s['netPayout']) ?>)" class="inline-flex items-center justify-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-bold border transition-all bg-[#075E54]/20 border-[#25D366]/40 text-[#25D366] hover:bg-[#075E54]/40 cursor-pointer">
    ...
    <div id="link-result-<?= (int)$m['id'] ?>" class="hidden px-5 pb-5"></div>
