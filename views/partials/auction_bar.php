...
<div id="addAuctionForm" class="hidden bg-ak-bg2 border-b border-ak-border px-4 md:px-7 py-4 animate-slide-down">
  <form onsubmit="return submitAddAuction(event)" data-parsley-validate class="w-full max-w-2xl">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mb-0">
      ...
      <div><label class="lbl">Commission Fee (¥)</label><input class="inp font-mono" name="commission_fee" type="number" min="0" value="3300" placeholder="3,300"></div>
      <div class="flex items-end sm:col-span-2 md:col-span-3 sm:justify-end"><button class="btn btn-gold w-full sm:w-auto" type="submit">+ Create</button></div>
    </div>
  </form>
</div>
