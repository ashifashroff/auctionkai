...
<div class="bg-ak-card border border-ak-gold/30 rounded-xl p-8 text-center">
  ...
  <span class="text-[10px] bg-ak-gold/20 text-ak-gold px-2 py-0.5 rounded font-mono">v2.3</span>
...
<div class="bg-ak-card border border-ak-border rounded-xl p-7">
  ...
  <div class="space-y-3">
    <div class="flex items-start gap-3"><span class="text-ak-gold font-mono text-xs bg-ak-gold/10 px-2 py-0.5 rounded shrink-0">v2.3</span><span class="text-ak-text2 text-sm">Security hardening, Parsley.js validation, auth/ restructure</span></div>
    <div class="flex items-start gap-3"><span class="text-ak-muted font-mono text-xs bg-ak-border px-2 py-0.5 rounded shrink-0">v2.2</span><span class="text-ak-text2 text-sm">AJAX vehicle editing, member detail modal</span></div>
    <div class="flex items-start gap-3"><span class="text-ak-muted font-mono text-xs bg-ak-border px-2 py-0.5 rounded shrink-0">v2.1</span><span class="text-ak-text2 text-sm">MySQL migration, multi-auction support</span></div>
