...
<div class="bg-ak-card border border-ak-border rounded-xl p-7">
  ...
  <div class="space-y-3">
    <div class="flex items-start gap-3"><span class="text-ak-gold font-mono text-xs bg-ak-gold/10 px-2 py-0.5 rounded shrink-0">v4.0</span><span class="text-ak-text2 text-sm">Live vehicle payout preview, nagare-only statement cards with commission toggle, inline confirm dialogs, decluttered topbar, password show/hide toggles, shareable links for all members</span></div>
