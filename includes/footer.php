...
<footer class="bg-ak-bg2 border-t border-ak-border px-7 py-8 w-full mt-auto">
  <div class="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div>
      ...
      <div class="mt-2"><span class="text-[10px] bg-ak-border text-ak-muted px-2 py-0.5 rounded font-mono">v3.0</span></div>
    </div>
    <!-- Column 2 — System -->
    <div>
      <div class="text-[10px] font-bold tracking-[2px] uppercase text-ak-muted mb-3">System</div>
      <div class="flex flex-col gap-1.5">
        <a href="index.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">Home</a>
        <a href="profile.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">Profile</a>
        <a href="help.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">Help</a>
        <a href="about.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">About</a>
      </div>
    </div>
    <!-- Column 3 — Legal -->
    <div>
      ...
      <div class="flex flex-col gap-1.5">
        <a href="privacy.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">Privacy Policy</a>
        <a href="terms.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">Terms of Use</a>
        <a href="contact.php" class="text-ak-muted hover:text-ak-gold transition-colors text-sm">Contact</a>
      </div>
    </div>
  </div>
  <!-- Bottom Bar -->
