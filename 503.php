...
<title>503 — Maintenance | AuctionKai</title>
...
.error-code{font-family:'Space Mono',monospace;font-size:6rem;font-weight:700;color:var(--ak-gold);line-height:1;margin-bottom:.5rem}
...
<div class="container">
  ...
  <div class="message">We're currently performing scheduled maintenance.<br>We'll be back shortly. Thank you for your patience.</div>
  <a href="javascript:location.reload()" class="btn btn-gold">↻ Try Again</a>
</div>
